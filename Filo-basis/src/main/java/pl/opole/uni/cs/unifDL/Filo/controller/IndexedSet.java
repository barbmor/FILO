 ...
 * 
 * Copied to Filo from Uel by Barbara Morawska.
 *
 * @author Julian Mendez
 * 
 * @param <T> type of the object stored in this indexed set
 */
public interface IndexedSet<T> extends Set<T> {

	/**
	 * Adds an element to this indexed set with a given index. If the given element
	 * has been used with a different index or the index with a different element,
	 * an exception is thrown.
	 * 
	 * @param element element
	 * @param index   index
	 * @return <code>true</code> if and only if this indexed set has been modified.
	 * @throws IllegalArgumentException when trying to add an existing element with
	 *                                  a different index or a new element with a
	 *                                  used index
	 */
	boolean add(T element, Integer index);

	/**
	 * Adds an element to this indexed set and returns its index. If the element is
	 * already in the set, this method just retrieves its index.
	 * 
	 * @param element element
